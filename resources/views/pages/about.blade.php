        ...
        <div class="container">
                ...
                <div class="card-body p-md-10 py-xl-11 px-xl-15">
                    <div class="row gx-lg-8 gx-xl-0 gy-10 align-items-center">
                        <div class="col-lg-6 order-lg-2 d-flex position-relative">
                            <img class="img-fluid ms-auto mx-auto me-lg-8" src="./assets/img/photos/co3.png"
                                srcset="./assets/img/photos/co3@2x.png 2x" alt="" data-cue="fadeIn">
                                ...
                                <div class="card shadow-lg position-absolute" style="bottom: 10%; right: -3%;">
                                    <div class="card-body py-4 px-5">
                                        <div class="d-flex flex-row align-items-center">
                                            <div>
                                                <div
                                                    class="icon btn btn-circle btn-md btn-soft-primary disabled mx-auto me-3">
                        ...
                        <div class="col-lg-6 text-center text-lg-start" data-cues="slideInDown" data-group="page-title"
                            ...
                            <p class="lead fs-lg lh-sm mb-7 pe-xl-10">We're a company that focuses on establishing
                            ...
                            <div class="d-flex justify-content-center justify-content-lg-start" data-cues="slideInDown"
                                ...
                                <span><a href="#" class="btn btn-lg btn-primary rounded-pill me-2">Explore
                                        Now</a></span>
            ...
            <div class="row gx-lg-8 gx-xl-12 gy-10 gy-lg-0 mb-13 mb-md-17">
                ...
                <div class="col-lg-8">
                    <div class="row row-cols-2 row-cols-md-4 gx-0 gx-md-8 gx-xl-12 gy-11 mt-n10">
                        <div class="col">
                            <figure class="px-4 px-lg-3 px-xxl-5"><img src="./assets/img/brands/c10.png" alt="" />
                            </figure>
                        </div>
                        <!--/column -->
                        <div class="col">
                            <figure class="px-4 px-lg-3 px-xxl-5"><img src="./assets/img/brands/c2.png" alt="" />
                            </figure>
                        </div>
                        <!--/column -->
                        <div class="col">
                            <figure class="px-4 px-lg-3 px-xxl-5"><img src="./assets/img/brands/c3.png" alt="" />
                            </figure>
                        </div>
                        <!--/column -->
                        <div class="col">
                            <figure class="px-4 px-lg-3 px-xxl-5"><img src="./assets/img/brands/c4.png" alt="" />
                            </figure>
                        </div>
                        <!--/column -->
                        <div class="col">
                            <figure class="px-4 px-lg-3 px-xxl-5"><img src="./assets/img/brands/c5.png" alt="" />
                            </figure>
                        </div>
                        <!--/column -->
                        <div class="col">
                            <figure class="px-4 px-lg-3 px-xxl-5"><img src="./assets/img/brands/c6.png" alt="" />
                            </figure>
                        </div>
                        <!--/column -->
                        <div class="col">
                            <figure class="px-4 px-lg-3 px-xxl-5"><img src="./assets/img/brands/c7.png" alt="" />
                            </figure>
                        </div>
                        <!--/column -->
                        <div class="col">
                            <figure class="px-4 px-lg-3 px-xxl-5"><img src="./assets/img/brands/c8.png" alt="" />
                            </figure>
                        </div>
                        <!--/column -->
                    </div>
            ...
            <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-18 align-items-center">
                <div class="col-md-8 col-lg-6 position-relative">
                    ...
                    <figure class="rounded"><img src="./assets/img/photos/about10.jpg"
                            srcset="./assets/img/photos/about10@2x.jpg 2x" alt=""></figure>
                </div>
                <!--/column -->
                <div class="col-lg-6">
                    <h2 class="display-4 mb-3">Who Are We?</h2>
                    <p class="lead fs-lg">We are a digital and branding company that believes in the power of <span
                            class="underline">creative strategy</span> and along with great design.</p>
            ...
            <div class="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-20 align-items-center">
                <div class="col-md-8 col-lg-6 order-lg-2 position-relative">
                    ...
                    <figure class="rounded"><img src="./assets/img/photos/about11.jpg"
                            srcset="./assets/img/photos/about11@2x.jpg 2x" alt=""></figure>
                </div>
                <!--/column -->
                <div class="col-lg-6">
            ...
            <div class="card bg-soft-primary rounded-4 mb-14 mb-md-18">
                <div class="card-body p-md-10 py-xxl-16 position-relative">
                    <div class="position-absolute d-none d-lg-block" style="bottom:0; left:10%; width: 28%; z-index:2">
                        <figure><img src="./assets/img/photos/co2.png" srcset="./assets/img/photos/co2@2x.png 2x"
                                alt=""></figure>
                    </div>
                        ...
                        <div class="col-lg-7 offset-lg-5 col-xl-6">
                            ...
                            <blockquote class="border-0 fs-lg mb-0">
                                <p>“Fusce dapibus tellus ac cursus commodo, tortor mauris condimentum nibh ut fermentum
                                    ...
                                    auctor. Cras mattis consectetur purus sit amet fermentum. Aenean lacinia bibendum
                                    nulla sed”</p>
            ...
            <div class="row gy-6 align-items-center mb-14 mb-md-18">
                <div class="col-lg-4">
                    ...
                    <p class="lead fs-lg mb-5">Enjoy a <span class="underline">free 30-day trial</span> and experience
                        the full service. No credit card required!</p>
                ...
                <div class="card-body p-md-10 p-xl-11">
                    <div class="row gx-lg-8 gx-xl-12 gy-10">
                        <div class="col-lg-6">
                            ...
                            <p class="lead fs-lg mb-0">If you don't see an answer to your question, you can send us an
                                email from our contact form.</p>
                        </div>
                        <!--/column -->
                        <div class="col-lg-6">
                                ...
                                <div class="card plain accordion-item">
                                    <div class="card-header" id="headingOne">
                                        <button class="collapsed" data-bs-toggle="collapse"
                                            ...
                                            aria-controls="collapseOne">How do I get my subscription receipt?</button>
                                    </div>
                                    <!--/.card-header -->
                                ...
                                <div class="card plain accordion-item">
                                    <div class="card-header" id="headingTwo">
                                        <button class="collapsed" data-bs-toggle="collapse"
                                            ...
                                            aria-controls="collapseTwo">Are there any discounts for people in
                                            need?</button>
                                    </div>
                                    <!--/.card-header -->
                                ...
                                <div class="card plain accordion-item">
                                    <div class="card-header" id="headingThree">
                                        <button class="collapsed" data-bs-toggle="collapse"
                                            ...
                                            aria-controls="collapseThree">Do you offer a free trial edit?</button>
                                    </div>
                                    <!--/.card-header -->
                                ...
                                <div class="card plain accordion-item">
                                    <div class="card-header" id="headingFour">
                                        <button class="collapsed" data-bs-toggle="collapse"
                                            ...
                                            aria-controls="collapseFour">How do I reset my Account password?</button>
                                    </div>
                                    <!--/.card-header -->
